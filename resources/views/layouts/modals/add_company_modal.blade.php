...
<div class="modal fade" id="addCompanyModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg modal-add-company" role="document">
    <div class="modal-content">
      <div class="card card-add-company card-plain">
        <div class="card-header card-header-info">
          <h2 class="modal-title card-title">New Company</h2>
          ...
          <div class="row">
            ...
            <form method="POST" action="/add-company">
                ...
                <div class="form-group">
                    ...
                    <input type="textarea" class="form-control" id="state" name="state" required>
                </div>
                <div class="form-group">
                    <label for="city">City</label>
                    <input type="textarea" class="form-control" id="city" name="city" required>
                </div>
                <div class="form-group">
